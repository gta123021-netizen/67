...
---------------------------------------------------------------------------
-- blood (client-side, cosmetic). A clean blow sprays from the contact point along the way it
-- drove: a fine mist, streaks and a few heavy drops. The drops are real ballistic droplets: each
-- one flies, falls and - where it meets the floor, a wall or a slope - leaves a splatter lying flat
-- on that surface, stretched the way it was travelling. Splatters dry (darken), fade and are reused.
--   Mist / Streaks / Drops   per tier: particle counts and the number of flying droplets
--   Speed { min, max }       droplet launch speed along the blow (studs/s); Up = extra lift
--   Spread                   cone half-angle (degrees)
---------------------------------------------------------------------------
Config.Blood = {
	Enabled = true,
	Color = Color3.fromRGB(96, 4, 6), -- fresh
	Dry = Color3.fromRGB(58, 6, 6), -- as it dries on the floor
	Gravity = 118, -- droplet fall (studs/s^2): a touch lighter than the world's, cinematic
	Drag = 1.6, -- air drag on the droplets (1/s)
	Tiers = {
		Light = { Mist = 10, Streaks = 5, Drops = 4, Speed = { 9, 17 }, Up = 5, Spread = 30, Size = 1 },
		Hook = { Mist = 13, Streaks = 7, Drops = 6, Speed = { 10, 19 }, Up = 4, Spread = 38, Size = 1.05 },
		Heavy = { Mist = 20, Streaks = 11, Drops = 9, Speed = { 12, 23 }, Up = 11, Spread = 34, Size = 1.25, Splash = true },
		Finisher = { Mist = 26, Streaks = 14, Drops = 12, Speed = { 12, 25 }, Up = 7, Spread = 42, Size = 1.35, Splash = true, Pool = true },
		Body = { Mist = 14, Streaks = 7, Drops = 6, Speed = { 8, 16 }, Up = 3, Spread = 45, Size = 1.1 },
	},
